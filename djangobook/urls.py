...
urlpatterns = patterns('',
    ...
    url(r'^create_project$',login_required(CreateView.as_view(model=Project, 
        template_name="example_app/create_project.html",success_url='index')),name="create_project"),
    url(r'^create_task$',login_required(CreateView.as_view(model=Task, 
        template_name="example_app/create_task.html",success_url="index")),name="create_task"),
    ...
    url(r'^project_list$',login_required(ListView.as_view(model=Project,
        template_name="example_app/detail_project.html")),name="project_detail"),
